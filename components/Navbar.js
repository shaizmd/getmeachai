        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <Link 
                href="/discover" 
                className="text-gray-700 hover:text-orange-500 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 hover:bg-orange-50"
              >
                Discover
              </Link>
              <Link 
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-64 pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
              />
              <Search className="absolute left-3 top-2.5 h-4 w-4 text-gray-400" />
            </div>

            {/* Start Creating Button */}
            <button className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer">
              Start Creating
            </button>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100">
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link 
              href="/discover" 
              className="text-gray-700 hover:text-orange-500 block px-3 py-2 rounded-md text-base font-medium hover:bg-orange-50 transition-colors duration-200"
            >
              Discover
            </Link>
            <Link 
            ...
            <div className="flex space-x-2">
              {session ? (
                ...
                <>
                  <Link 
                    href="/signin"
                    className="flex-1 text-center text-gray-700 hover:text-orange-500 px-4 py-2 rounded-full border border-gray-200 hover:border-orange-500 text-sm font-medium transition-all duration-200"
                  >
                    Sign In
                  </Link>
                  <Link 
                    href="/signup"
                    className="flex-1 text-center text-orange-500 hover:text-white px-4 py-2 rounded-full border border-orange-500 hover:bg-orange-500 text-sm font-medium transition-all duration-200"
                  >
                    Sign Up
                  </Link>
                </>
