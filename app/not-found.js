    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full">
        <div className="text-center">
          {/* Large 404 with Coffee Cup Animation */}
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              Still having trouble? <a href="/contact" className="text-orange-500 hover:text-orange-600 font-medium transition-colors duration-200">Contact Support</a>
            </p>
          </div>
        </div>
      </div>
